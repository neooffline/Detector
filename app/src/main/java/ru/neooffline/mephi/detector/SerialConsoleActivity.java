...
public class SerialConsoleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        chkDTR = findViewById(R.id.checkBoxDTR);
        chkRTS = findViewById(R.id.checkBoxRTS);
    ...
    protected void onResume() {
        ...
        if (sPort == null) {
            ...
            try {
                ...
                byte[] bytes={(byte) 0xAA,(byte)0x05,(byte)0x01,(byte)0x00,(byte)0x00,(byte)0x00,(byte)2,(byte)(2+1)};
                startIoManager();
